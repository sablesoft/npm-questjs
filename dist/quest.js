...
} : "download" in HTMLAnchorElement.prototype && !isMacOSWebView ? function saveAs3(blob, name2, opts) {
...
} : "msSaveOrOpenBlob" in navigator ? function saveAs4(blob, name2, opts) {
  name2 = name2 || blob.name || "download";
  if (typeof blob === "string") {
    if (corsEnabled(blob)) {
...
} : function saveAs5(blob, name2, opts, popup) {
...
export {
  ...
  getDir,
  getResponseList,
  handleEmptyFluidInto,
  handleFillFromSource,
  handleFillFromUnknown,
  handleFillFromVessel,
  handleGiveToNpc,
