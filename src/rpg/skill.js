...
import {cloneObject, falsemsg, lang, msg, player} from "../index.js";
...
class SpellTransformInanimate extends SpellInanimate {
  ...
  getTargets(attack) {
      return scopeHereParser().filter(el => el['transform_' + this.prototype])
  }
  ...
  targetEffect(attack, item) {
    ...
    item['transform_' + this.prototype](o)
      // todo - Value assigned to primitive will be lost
