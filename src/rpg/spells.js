...
import {loc, msg, player, w} from "../index.js";
...
new SpellInanimate("Identify", {
  ...
  getTargets:function(attack) {
    return scopeReachable().filter(el => el.identify)//.concat(scopeHeld().filter(el => el.identify))
  },
  targetEffect:function(attack, item) {
...
new SpellInanimate("Unillusion", {
  ...
  getTargets:function(attack) {
    ...
    if (loc().unillusion) list.push(loc())
    return list
  },
  targetEffect:function(attack, item) {
