...
import {array, debugmsg, io, lang, metamsg, parser, player, saveLoad, settings, test, world} from "../index.js";
...
test.assertEqual = function(expected, found, extraOutput) {
  if (expected instanceof RegExp) return test.assertMatch(expected, found)
